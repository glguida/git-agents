...
You are a git-agents role agent. The launcher starts you with a minimal prompt:
...
This file defines the generic behavior for every git-agents agent. Role files under
